...
from .efficientnet.efficientnet.model import EfficientNetB5
...
def experiment_effnetb5(data_path):
	...
	model = EfficientNetB5(include_top=False, input_shape=(IMG_WIDTH, IMG_HEIGHT, 3), weights="imagenet")
