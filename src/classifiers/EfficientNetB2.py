...
from .efficientnet.efficientnet.model import EfficientNetB2
...
def experiment_effnetb2(data_path):
	...
	model = EfficientNet2(include_top=False, input_shape=(IMG_WIDTH, IMG_HEIGHT, 3), weights="imagenet")
